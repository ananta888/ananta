...
def test_delegate_requires_hub_role(client, monkeypatch, admin_auth_header):
    client.post("/tasks", json={"id": "parent-1", "description": "parent task"}, headers=admin_auth_header)
