...
def context(**overrides):
    base = MediaTopologyContext(
        current="ordinary_direct", participant_count=4, now_ms=20_000, last_transition_ms=0,
...
@pytest.mark.parametrize(
    ("changes", "target"),
    [
        ({"feature_killed": True}, "ordinary_direct"),
        ({"sfu_e2ee_ready": False}, "ordinary_direct"),
        ({"sfu_admitted": False}, "ordinary_direct"),
        ({"user_override": "ordinary"}, "ordinary_direct"),
