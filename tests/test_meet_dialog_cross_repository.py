...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            False,
            "playback-latency",
            id="speech-playback-latency",
            marks=pytest.mark.skipif(SOAK_SECONDS > 0, reason="short Python playback delay gate"),
        ),
        pytest.param(
            True,
            False,
            ...
            False,
            "playback-stall",
            id="speech-playback-watchdog",
            marks=pytest.mark.skipif(SOAK_SECONDS > 0, reason="short Worker stall watchdog gate"),
        ),
        pytest.param(
            True,
            False,
