...
def test_task_execute_completes_research_artifact_without_shell(client, app):
    tid = "T-RESEARCH-2"
    artifact = {
    ...
    with app.app_context():
        ...
        _update_local_task_status(
            ...
            last_proposal={"backend": "deerflow", "reason": "summary", "research_artifact": artifact},
        )
    ...
    assert response.json["data"]["output"].startswith("# Report")
