...
def test_plugin_golden_path_surface_detection(tmp_path: Path) -> None:
    ...
    <plugin>
      <extension point="org.eclipse.ui.commands">
        ...
        <command id="io.ananta.eclipse.command.snake_toggle"/>
        <command id="io.ananta.eclipse.command.snake_ask"/>
      </extension>
      <extension point="org.eclipse.ui.views">
        <view id="io.ananta.eclipse.view.chat"/>
        <view id="io.ananta.eclipse.view.snake"/>
...
def test_plugin_golden_path_surface_detection_fails_without_snake_surfaces(tmp_path: Path) -> None:
    plugin_jar = tmp_path / "io.ananta.eclipse.runtime.jar"
    plugin_xml = """
    <plugin>
      <extension point="org.eclipse.ui.commands">
    ...
    assert ok is False
    assert "io.ananta.eclipse.command.snake_toggle" in missing
    assert "io.ananta.eclipse.view.snake" in missing
