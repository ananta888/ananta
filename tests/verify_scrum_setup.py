...
BASE_URL = os.getenv("HUB_URL", "http://localhost:5000")
AUTH_TOKEN = os.getenv("AGENT_TOKEN", "")
...
def test_create_scrum_team():
    ...
    res = requests.post(f"{BASE_URL}/teams/setup-scrum", json={"name": team_name}, headers=headers)
    ...
    expected_titles = ["Scrum Backlog", "Sprint Board Setup", "Burndown Chart", "Roadmap", "Setup & Usage Instructions"]
