...
RELATION_PRIORITY = {
    "extends": 100,
    "implements": 95,
    "permission_checks_field": 95,
    "interceptor_guards_method": 95,
    "role_allows_operation": 92,
    "test_targets_type": 92,
    "controller_endpoint_declares": 92,
    "test_uses_controller": 90,
    "test_calls_endpoint": 88,
    "mock_injects_dependency": 85,
    "returns": 90,
    ...
    "uses_type": 85,
    "field_type_uses": 85,
    "method_param_type_uses": 85,
    "method_return_type_uses": 85,
    "generic_type_uses": 82,
    "calls_probable_target": 80,
    "duplicate_candidate": 75,
    "contains_child_tag": 30,
    "calls": 25,
    "declares_method": 10,
    "declares_property": 10,
    "declares_constructor": 10,
    "property_type_uses": 10,
    "contains_type": 5,
    "child_of_type": 5,
    "child_of_file": 5,
}
