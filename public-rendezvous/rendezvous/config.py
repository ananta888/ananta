...
RATE_RECOVERY_PROBE_LIMIT = _positive_int_env("RATE_RECOVERY_PROBE_LIMIT", 30)
RATE_RECOVERY_PROBE_WINDOW = _positive_int_env("RATE_RECOVERY_PROBE_WINDOW", 60)
RATE_MEMBERSHIP_PROBE_LIMIT = _positive_int_env("RATE_MEMBERSHIP_PROBE_LIMIT", 120)
RATE_MEMBERSHIP_PROBE_WINDOW = _positive_int_env("RATE_MEMBERSHIP_PROBE_WINDOW", 10)
