...
def collect_benchmark_result(report_path: Path) -> dict[str, Any]:
    ...
    out["details"] = {
        ...
        "artifact_flow": details.get("artifact_flow"),
        "execution_reconciliation": details.get("execution_reconciliation"),
        "operations_console": details.get("operations_console"),
