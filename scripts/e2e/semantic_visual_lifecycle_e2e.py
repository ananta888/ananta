#!/usr/bin/env python3
"""Run or explicitly mark unavailable the real two-browser visual lifecycle gate."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=ROOT / "artifacts/e2e/semantic-visual-lifecycle-report.json",
    )
    args = parser.parse_args()
    evidence = run_playwright_gate(
        gate_id="ASMP-VIS-012",
        spec="semantic-visual-lifecycle.spec.ts",
