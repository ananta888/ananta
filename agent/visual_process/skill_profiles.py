...
_BUILTIN_PROFILES: list[AgentSkillProfile] = [
    AgentSkillProfile(
        ...
        role="developer",
        task_kinds=["coding", "refactor", "bugfix", "code_review"],
    ...
    AgentSkillProfile(
        ...
        role="analyst",
        task_kinds=["analysis", "research", "read_file", "grep_search"],
    ...
    AgentSkillProfile(
        ...
        role="qa",
        task_kinds=["testing", "run_tests", "write_tests"],
    ...
    AgentSkillProfile(
        ...
        role="architect",
        task_kinds=["goal_plan", "goal_propose", "spec", "breakdown"],
    ...
    AgentSkillProfile(
        ...
        role="reviewer",
        task_kinds=["code_review", "doc_review", "review"],
    ...
    AgentSkillProfile(
        ...
        role="devops",
        task_kinds=["deploy", "ci", "infra", "run_tests"],
