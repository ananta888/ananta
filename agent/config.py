...
class Settings(BaseSettings):
    ...
    terminal_oidc_client_secret: str = Field(default="", validation_alias="TERMINAL_OIDC_CLIENT_SECRET")
    ...
    # Evolution provider plugin defaults
