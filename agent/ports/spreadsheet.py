"""Neutral persistence contracts for the spreadsheet domain."""
...
class SpreadsheetStoreConflict(RuntimeError):
    """A document-store command conflicts with durable Hub state."""


class SpreadsheetLearningConflict(RuntimeError):
    """An immutable learning command was replayed with different content."""
...
__all__ = [
    "SpreadsheetLearningConflict",
    "SpreadsheetLearningRepository",
    "SpreadsheetStoreConflict",
]
