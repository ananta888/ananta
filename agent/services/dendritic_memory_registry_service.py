    ...
    def approve_evaluated(
        ...
        *,
        ...
        return self._append(
            ...
            idempotency_key=idempotency_key,
            extra={"evaluation_digest": require_digest(evaluation.get("evaluation_digest"), "evaluation_digest")},
        )
    ...
    def _initialize(self) -> None:
        ...
        with self._connect() as connection:
            ...
            connection.execute(
                ...
                "revision INTEGER NOT NULL,pack_digest TEXT NOT NULL,active INTEGER NOT NULL,"
                "payload_json TEXT NOT NULL,"
                "PRIMARY KEY(tenant_id,scope_id,revision))"
            )
            connection.execute(
                "CREATE TABLE IF NOT EXISTS dendritic_registry_idempotency(tenant_id TEXT NOT NULL,"
