...
class TaskExecutionTrackingService:
    ...
    def build_artifact_flow_read_model(self, *, overrides: dict | None = None) -> dict:
        ...
        effective = self._normalize_artifact_flow_config({**configured, **dict(overrides or {})})
        payload: dict = {
        ...
        for task in sorted_tasks:
            ...
            for job in worker_jobs:
                ...
                job_sent_artifact_ids = self._extract_artifact_ids_from_chunks((bundle.chunks if bundle else None) or [])
