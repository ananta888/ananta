...
_REGISTRY: dict[str, AnantaToolSpec] = {
    ...
    for spec in [
        ...
        _spec(
            ...
            CATEGORY_READ_ONLY,
            RISK_READ,
            "Search internal project knowledge via CodeCompass hybrid retrieval. Use this for repository, symbol, architecture and documentation questions. Do not pass Qdrant collections or credentials.",
            {
                "query": {"type": "string"},
                "limit": {"type": "integer"},
                "mode": {"type": "string"},
                "requested_signals": {"type": "array"},
                "task_kind": {"type": "string"},
        ...
        _spec(
            ...
            CATEGORY_READ_ONLY,
            RISK_READ,
            "Canonical CodeCompass agentic retrieval. Returns budgeted evidence, plan diagnostics and typed errors without exposing vector-store backends.",
            {
                "query": {"type": "string"},
                "mode": {"type": "string"},
                "requested_signals": {"type": "array"},
        ...
        _spec(
            ...
            CATEGORY_READ_ONLY,
            RISK_READ,
            "Return a budgeted System/Subsystem/Component architecture slice for a question.",
            {"query": {"type": "string"}, "profile": {"type": "string"}, "revision": {"type": "string"}},
            requires_workspace=False,
        ),
        _spec(
            ...
            CATEGORY_READ_ONLY,
            RISK_READ,
            "Expand one architecture node handle without loading the full graph.",
            {"handle": {"type": "string"}, "node": {"type": "string"}, "query": {"type": "string"}, "revision": {"type": "string"}},
            requires_workspace=False,
        ),
        _spec(
            ...
            CATEGORY_READ_ONLY,
            RISK_READ,
            "Load component-level architecture context for a handle.",
            {"handle": {"type": "string"}, "node": {"type": "string"}, "revision": {"type": "string"}},
            requires_workspace=False,
        ),
        _spec(
            ...
            CATEGORY_READ_ONLY,
            RISK_READ,
            "Show bounded dependencies of an architecture node.",
            {"handle": {"type": "string"}, "query": {"type": "string"}, "revision": {"type": "string"}},
            requires_workspace=False,
        ),
        _spec(
            "codecompass.symbol_context",
            CATEGORY_READ_ONLY,
            RISK_READ,
            "Symbol-level architecture evidence for a query.",
            {"query": {"type": "string"}, "symbol": {"type": "string"}, "revision": {"type": "string"}},
            requires_workspace=False,
        ),
        _spec(
            ...
            CATEGORY_READ_ONLY,
            RISK_READ,
            "Evidence-focused architecture slice for grounding.",
            {"query": {"type": "string"}, "revision": {"type": "string"}},
            requires_workspace=False,
        ),
        _spec(
        ...
        _spec(
            ...
            CATEGORY_READ_ONLY,
            RISK_READ,
            "Render a deterministic Mermaid diagram from the authorized architecture slice.",
            {"query": {"type": "string"}, "diagram_kind": {"type": "string"}, "profile": {"type": "string"}},
            requires_workspace=False,
        ),
        _spec(
        ...
        _spec(
            ...
            CATEGORY_CONTROLLED_EXECUTION,
            RISK_EXECUTION,
            "Run an allowlisted profiling command and create bounded profile artifacts.",
            {
            ...
            requires_approval=True,
            execution_plane=PLANE_WORKER_RUNTIME,
        ),
        _spec(
            "performance.run_benchmark",
            CATEGORY_CONTROLLED_EXECUTION,
            RISK_EXECUTION,
            "Run an allowlisted benchmark command and create BenchmarkRunArtifact.",
            {
                "profile_id": {"type": "string"},
                "command": {"type": "string"},
        ...
        _spec(
            ...
            CATEGORY_READ_ONLY,
            RISK_READ,
            "Compare baseline and candidate benchmark artifacts.",
            {
            ...
            requires_workspace=False,
            execution_plane=PLANE_HUB_CONTROL_ONLY,
        ),
        _spec(
            "performance.create_experiment_plan",
            CATEGORY_READ_ONLY,
            RISK_READ,
            "Create a plan-only performance experiment artifact.",
            {
        ...
        _spec(
            ...
            CATEGORY_READ_ONLY,
            RISK_READ,
            "Summarize performance experiment artifacts for human review.",
            {
                "trace_bundle": {"type": "array"},
            },
            requires_workspace=False,
            execution_plane=PLANE_HUB_CONTROL_ONLY,
        ),
        ...
        _spec(
            ...
            CATEGORY_READ_ONLY,
            RISK_READ,
            "List allowlisted profiles exposed by the configured external Webcrawler.",
            {},
            requires_workspace=False,
        ),
        _spec(
            ...
            CATEGORY_READ_ONLY,
            RISK_READ,
            "Read profile validation and external Webcrawler health status.",
            {"profile": {"type": "string"}},
            requires_workspace=False,
        ),
        _spec(
            ...
            CATEGORY_CONTROLLED_EXECUTION,
            RISK_EXTERNAL_AGENT,
            "Execute an allowlisted external Webcrawler profile under Hub policy.",
            {
                "profile": {"type": "string"},
                "prompt": {"type": "string"},
                "messages": {"type": "array"},
        ...
        _spec(
            "webcrawler.record_flow",
            CATEGORY_CONTROLLED_EXECUTION,
            RISK_EXTERNAL_AGENT,
            "Ask the external Webcrawler to record a flow when Hub policy enables it.",
            {"profile": {"type": "string"}, "request": {"type": "object"}},
            requires_approval=True,
            requires_workspace=False,
        ),
        _spec(
            "webcrawler.validate_profile",
            CATEGORY_CONTROLLED_EXECUTION,
            RISK_EXTERNAL_AGENT,
            "Validate an external Webcrawler profile after an automatic Hub grant.",
            {"profile": {"type": "string"}, "request": {"type": "object"}},
            requires_approval=True,
            requires_workspace=False,
        ),
        _spec(
            "webcrawler.publish_profile",
            CATEGORY_CONTROLLED_EXECUTION,
            RISK_EXTERNAL_AGENT,
            "Publish an external Webcrawler profile after an automatic Hub grant.",
            {"profile": {"type": "string"}, "request": {"type": "object"}},
            requires_approval=True,
            requires_workspace=False,
        ),
