...
_BACKEND_CAPABILITY_CLASSES: dict[str, list[str]] = {
    ...
    "qwen_code": ["patching", "shell_execution", "planning"],
    "gemini_cli": ["patching", "shell_execution", "planning"],
    "copilot_cli": ["patching", "shell_execution", "review"],
    "cline": ["patching", "shell_execution", "planning"],
    "kilo_code": ["patching", "shell_execution"],
