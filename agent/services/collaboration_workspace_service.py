...
class CollaborationWorkspaceService:
    def __init__(self, store: CollaborationWorkspaceStore, *, policy: CollaborationWorkspacePolicy) -> None:
        self._store = store
        self._policy = policy
    ...
    def timeline(
        ...
        *,
        ...
        return self._store.timeline(tenant_id, workspace_id, room_id=room_id, after=after, limit=limit)
    ...
    def search(
        ...
        *,
        ...
        self._authorize(tenant_id, workspace_id, principal_actor_id, "event.read")
        return self._store.search(tenant_id, workspace_id, query, limit=limit)
    ...
    def get_workspace(self, *, tenant_id: str, workspace_id: str, principal_actor_id: str) -> dict[str, Any]:
        self._authorize(tenant_id, workspace_id, principal_actor_id, "event.read")
        return {
            **self._store.get_workspace(tenant_id, workspace_id),
            "current_actor_binding_id": principal_actor_id,
        }
