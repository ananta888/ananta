        ...
        return {
            ...
            "examples": {
                ...
                "task_scoped_step_propose_response": TaskScopedStepProposeResponse(
                    ...
                    raw='{"reason":"Run unit tests first","command":"pytest -q"}',
                    backend="opencode",
                    routing={"task_kind": "coding", "effective_backend": "opencode", "reason": "adaptive_default", "required_capabilities": ["coding"]},
                ...
                "task_scoped_step_execute_response": TaskScopedStepExecuteResponse(
                    ...
                    status="completed",
                    retry_history=[],
                    cost_summary=CostSummaryContract(provider="opencode", model="gpt-4o-mini", tokens_total=42),
                    retries_used=0,
