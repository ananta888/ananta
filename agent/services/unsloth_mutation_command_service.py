...
def project_unsloth_capabilities(
    ...
    *,
    ...
    executable = frozenset(
        operation for operation in executable_operations if operation in _OPERATIONS
    )
    ...
    release_profile = {
        ...
        "reason_code": (
            None if release_available else "unsloth_release_profile_unavailable"
        ),
        "version": detected_version,
    }
    operations = {
        ...
        "runtime_handoff": {
            ...
            "reason_code": (
                None
                if "runtime_handoff" in executable
                else "unsloth_runtime_handoff_composition_unavailable"
            ),
        ...
        "cleanup": {
            ...
            "reason_code": (
                None
                if "cleanup" in executable
                else "unsloth_cleanup_composition_unavailable"
            ),
            "version": (
