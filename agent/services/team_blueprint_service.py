...
def reconcile_system_prompts(system_catalog) -> list[dict]:
    ...
    System prompts (names starting with 'system.') are stored alongside role-prompt
    templates in TemplateDB with is_seed=True. User-created templates (is_seed=False)
