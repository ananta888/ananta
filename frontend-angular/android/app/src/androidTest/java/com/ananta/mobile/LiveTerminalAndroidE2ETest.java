    ...
    public void voxtralDirectTranscriptionWorks() throws InterruptedException {
        ...
        runIfPresent(
            ...
            "window.__anantaVoxtralTranscribe='PENDING';"
                ...
                + "    var targetUrl=" + jsLiteral(arg("ananta.voxtral.model.url", "https://huggingface.co/cstr/voxtral-mini-4b-realtime-GGUF/resolve/main/voxtral-mini-4b-realtime-q4_k.gguf")) + ";"
                + "    var targetFile=" + jsLiteral(arg("ananta.voxtral.model.file", "voxtral-mini-4b-realtime-q4_k.gguf")) + ";"
                + "    var targetMinBytes=Number(" + jsLiteral(arg("ananta.voxtral.model.minBytes", "2400000000")) + ")||0;"
                ...
                + "    }"
                + "    if(runners.length>0){"
                + "      var pref=runners.find(function(r){var n=String((r&&r.name)||'').toLowerCase(); return n.indexOf('voxtral')>=0 || n.indexOf('crispasr')===0;});"
