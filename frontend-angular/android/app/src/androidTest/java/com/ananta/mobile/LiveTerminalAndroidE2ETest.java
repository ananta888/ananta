    ...
    public void voxtralDirectTranscriptionWorks() throws InterruptedException {
        ...
        runIfPresent(
            ...
            "window.__anantaVoxtralTranscribe='PENDING';"
                ...
                + "    var targetUrl=" + jsLiteral(arg("ananta.voxtral.model.url", "https://huggingface.co/andrijdavid/Voxtral-Mini-4B-Realtime-2602-GGUF/resolve/main/Q3_K.gguf")) + ";"
                + "    var targetFile=" + jsLiteral(arg("ananta.voxtral.model.file", "Q3_K.gguf")) + ";"
                + "    var targetMinBytes=Number(" + jsLiteral(arg("ananta.voxtral.model.minBytes", "1900000000")) + ")||0;"
