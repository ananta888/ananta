...
let OperationsConsoleComponent = class OperationsConsoleComponent {
    constructor() {
        this.dir = inject(AgentDirectoryService);
        this.api = inject(HubApiService);
...
OperationsConsoleComponent = __decorate([
    Component({
        standalone: true,
...
export { OperationsConsoleComponent };
//# sourceMappingURL=operations-console.component.js.map