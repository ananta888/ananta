...
let AiAssistantMessageListComponent = class AiAssistantMessageListComponent {
    constructor(domain) {
        this.domain = domain;
        this.chatHistory = [];
        this.busy = false;
        this.previewSource = new EventEmitter();
        this.copySourcePath = new EventEmitter();
        this.executeSgpt = new EventEmitter();
    ...
    clearSgptCommand(msg) {
        msg.sgptCommand = undefined;
    }
};
__decorate([
    Input()
], AiAssistantMessageListComponent.prototype, "chatHistory", void 0);
__decorate([
    Input()
], AiAssistantMessageListComponent.prototype, "busy", void 0);
__decorate([
    Output()
], AiAssistantMessageListComponent.prototype, "previewSource", void 0);
__decorate([
    Output()
], AiAssistantMessageListComponent.prototype, "copySourcePath", void 0);
__decorate([
    Output()
], AiAssistantMessageListComponent.prototype, "executeSgpt", void 0);
__decorate([
    Output()
], AiAssistantMessageListComponent.prototype, "confirmAction", void 0);
__decorate([
    Output()
], AiAssistantMessageListComponent.prototype, "cancelAction", void 0);
__decorate([
    ViewChild('chatBox')
], AiAssistantMessageListComponent.prototype, "chatBox", void 0);
AiAssistantMessageListComponent = __decorate([
    Component({
        standalone: true,
...
export { AiAssistantMessageListComponent };
//# sourceMappingURL=ai-assistant-message-list.component.js.map