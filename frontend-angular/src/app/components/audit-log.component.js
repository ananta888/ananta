...
let AuditLogComponent = class AuditLogComponent {
    ...
    actionTone(action) {
        ...
        if (a.includes('delete') || a.includes('blocked') || a.includes('failed'))
            return 'danger';
        if (a.includes('created') || a.includes('updated') || a.includes('enabled') || a.includes('setup'))
            return 'success';
        if (a.includes('lockout') || a.includes('banned'))
            return 'warn';
        return 'info';
    }
...
//# sourceMappingURL=audit-log.component.js.map