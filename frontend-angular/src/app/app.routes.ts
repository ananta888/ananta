...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'spreadsheet-studio', data: { breadcrumb: 'Spreadsheet Studio', area: 'Operate' }, loadComponent: () => import('./features/spreadsheet-studio/spreadsheet-studio-page.component').then(m => m.SpreadsheetStudioPageComponent) },
