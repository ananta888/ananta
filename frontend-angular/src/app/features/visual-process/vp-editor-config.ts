...
export const FALLBACK_KINDS: TaskKindInfo[] = [
  ...
  { id: 'ml_intern_build_lora_dataset', label: 'ML-Intern: LoRA Dataset', group: 'ml', dispatch_capable: false, description: '', implementation_status: 'production', implementation_state: 'wired_and_executable', risk_level: 'medium', uses_llm: false, uses_network: false, side_effects: ['read_workspace', 'write_files'], deterministic: true },
