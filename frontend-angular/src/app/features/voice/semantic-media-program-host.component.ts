  ...
  template: `
    @if (facade.view$ | async; as view) {
      <app-semantic-media-program-shell
        ...
        [ordinaryMediaE2eeReady]="view.ordinaryMediaE2eeReady"
        [ordinaryMediaReason]="view.ordinaryMediaReason"
        [ordinaryMediaPublicationConsent]="view.ordinaryMediaPublicationConsent"
        ...
        (ordinaryMediaPublicationConsentGrant)="facade.grantOrdinaryMediaPublicationConsent($event)"
        (ordinaryMediaPublicationConsentRevoke)="facade.revokeOrdinaryMediaPublicationConsent()"
