...
export class WebrtcMediaPanelComponent {
  ...
  reasonLabel(reasonCode: string): string {
    return ({
      ...
      public_ordinary_media_e2ee_awaiting_peer: 'Der sichere Medienpfad wartet auf die technische Bestätigung des Gegenübers.',
      ...
      public_media_peer_consent_pending: 'Der sichere Medienpfad wartet auf die technische Bestätigung des Gegenübers.',
      public_media_peer_activation_pending: 'Der sichere Medienpfad wartet auf die technische Bestätigung des Gegenübers.',
      public_media_technical_preparation_pending: 'Der verschlüsselte Medienpfad wird technisch vorbereitet.',
      public_media_publication_consent_required: 'Vor dem Senden eigener Medien ist eine Einwilligung erforderlich.',
      public_media_publication_consent_granting: 'Die eigene Medienfreigabe wird sicher aktiviert.',
      public_media_publication_consent_revoking: 'Die eigene Medienfreigabe wird sicher deaktiviert.',
      public_media_publication_consent_revoked: 'Die eigene Medienfreigabe ist deaktiviert.',
      public_media_publication_consent_expired: 'Die eigene Medienfreigabe ist abgelaufen.',
