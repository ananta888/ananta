...
export const controlPlaneRoutes: Routes = [
  { path: 'dashboard', canActivate: [projectContextGuard], data: routeDataFor('dashboard'), loadComponent: () => import('../../components/dashboard.component').then(m => m.DashboardComponent) },
