...
import { PersonaAssetReference, PersonaSelection, PersonaSelectionState } from './persona-profile.models';

/** A local draft only: no HTTP, publication, policy or inherited resolution. */
export class PersonaVisualDraft<K extends 'image' | 'video'> {
