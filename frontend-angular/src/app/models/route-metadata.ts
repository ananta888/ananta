...
export const APP_ROUTE_META: Record<string, AppRouteMeta> = {
  ...
  geomaps: { label: 'GeoMap Studio', area: 'Operate', navGroup: 'Arbeiten', navOrder: 11.5, simpleNav: true, projectScoped: true },
  ...
  voice: { label: 'Voice', area: 'Operate', navGroup: 'Arbeiten', navOrder: 44, simpleNav: true },
  ...
  'model-analysis': { label: 'Modellanalyse', area: 'Operate', navGroup: 'Betrieb', navOrder: 38.5, adminOnly: true, expertOnly: true },
