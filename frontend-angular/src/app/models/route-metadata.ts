...
export const APP_ROUTE_META: Record<string, AppRouteMeta> = {
  ...
  knowledge:  { label: 'Wissen',     area: 'Operate', navGroup: 'Arbeiten', navOrder: 31, simpleNav: true },
  wikipedia:  { label: 'Wikipedia',  area: 'Operate', navGroup: 'Arbeiten', navOrder: 32, simpleNav: true },
