...
let AppComponent = class AppComponent {
    constructor() {
        ...
        this.mobile = inject(MobileRuntimeService);
    ...
    currentArea() {
        ...
        if (url.startsWith('/settings') || url.startsWith('/templates') || url.startsWith('/teams'))
            return 'Configure';
        if (url.startsWith('/auto-planner') || url.startsWith('/webhooks'))
            return 'Automate';
        if (url.startsWith('/dashboard') || url.startsWith('/agents') || url.startsWith('/board') || url.startsWith('/graph') || url.startsWith('/archived') || url.startsWith('/operations') || url.startsWith('/artifacts'))
            return 'Operate';
        return 'General';
    }
    get routeUrl() {
