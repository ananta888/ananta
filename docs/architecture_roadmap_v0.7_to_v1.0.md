...
> This document is kept for context. Active guardrail scope and rollout guidance now live in `docs/hub-fallback-and-reliability.md`.
...
See `docs/hub-fallback-and-reliability.md` for details and rollout guidance.
