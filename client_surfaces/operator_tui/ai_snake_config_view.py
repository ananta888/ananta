...
from client_surfaces.operator_tui._ai_snake_config_helpers import (
    _append_unique,
    _default_models_for_backend,
    _persist_tui_chat_settings,
    _PERSISTENT_TUI_CONFIG_KEYS,
    _propagate_advanced_chat_to_env,
    _resolve_bool_pref,
    _resolve_text_pref,
    _set_model_state,
...
from client_surfaces.operator_tui._ai_snake_config_helpers import (
    _lmstudio_base_candidates,
    _model_id_from_row,
    _model_loaded_state_from_row,
)
