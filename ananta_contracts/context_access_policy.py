"""Pure context-access policy contracts shared by Hub and workers.

This module contains no persistence, route, task-queue, or runtime integration.
The Hub remains the sole policy authority; workers only perform assignment-bound
preflight verification with the same deterministic evaluator.
"""
